...
"""
    ...
    Compares controller trained on flat terrain - and on flat terrain using height field.
...
exp_path = [os.getenv("HOME") + '/Desktop/gpu_cluster/ray_results_targetvel/Tvel_QuantrupedMultiEnv_Centralized_TVel', 
     os.getenv("HOME") + '/Desktop/gpu_cluster/ray_results_targetvel/Tvel_QuantrupedMultiEnv_FullyDecentral_TVel', 
     os.getenv("HOME") + '/Desktop/gpu_cluster/ray_results_targetvel/Tvel_QuantrupedMultiEnv_Local_TVel',  
     os.getenv("HOME") + '/Desktop/gpu_cluster/ray_results_targetvel/Tvel_QuantrupedMultiEnv_TwoSides_TVel'] 
